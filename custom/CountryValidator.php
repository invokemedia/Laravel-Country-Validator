...
/**
 * Validate that a value is a valid country name
 */
class CountryValidator extends Validator
{
    /**
     * Validates that the given country exists
     * @param string $attribute name of attribute
     * @param mixed $value the value needing validation
     * @param array $parameters arguments passed to the rule
     * @return boolean
     */
